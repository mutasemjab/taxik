...
return [
    ...
    // Search and Filter
    'Search' => 'بحث',
    'Search_By_Name_Phone_Email' => 'البحث بالاسم، الهاتف، البريد الإلكتروني...',
    'All' => 'الكل',
    'Min_Balance' => 'الحد الأدنى للرصيد',
    'Max_Balance' => 'الحد الأقصى للرصيد',
    'Reset' => 'إعادة تعيين',
    'Filter' => 'تصفية',
    ...
    'reason' => 'السبب',
    // Waiting settings
    'Free_Waiting_Minutes' => 'الدقائق المجانية للانتظار',
    'Free_Waiting_Minutes_Info' => 'الوقت المجاني الذي ينتظره السائق للعميل عند الوصول إليه وقبل بدء الرحلة.',

    'Waiting_Charge_Per_Minute' => 'سعر دقيقة الانتظار عند الوصول',
    'Waiting_Charge_Per_Minute_Info' => 'سعر دقيقة الانتظار التي يتم احتسابها على العميل من قبل السائق عند الوصول إليه.',

    'In_Trip_Waiting_Charge' => 'سعر دقيقة الانتظار أثناء الرحلة',
    'In_Trip_Waiting_Charge_Info' => 'سعر دقيقة الانتظار التي يتم احتسابها على العميل خلال الرحلة.',
    // General
    'Pages' => 'الصفحات',
    'New' => 'جديد',
    'Add_New' => 'إضافة',
    ...
    'الرسوم المترتبة عند تجاوز عدد الإلغاءات',

    'new_user_register_add_balance' =>
    'رصيد ترحيبي عند تسجيل مستخدم جديد',

    'new_driver_register_add_balance' =>
    'رصيد ترحيبي عند تسجيل سائق جديد',

    'find_drivers_in_radius' =>
    'نطاق البحث الأولي عن السائقين (كم)',

    'maximum_radius_to_find_drivers' =>
    'الحد الأقصى لنطاق البحث عن السائقين (كم)',
    'Entity_Type' => 'النوع',
    'Select_Entity_Type' => 'اختر النوع',
    // التقارير المالية - الرئيسية
    'Financial_Reports' => 'التقارير المالية',
    'Drivers_Financial_Reports' => 'التقارير المالية للسائقين',
    'POS_Financial_Report' => 'التقرير المالي لنقاط البيع',
    'Overall_Summary' => 'الملخص الإجمالي',
    ...
    'Driver' => 'السائق',
    'All_Drivers' => 'جميع السائقين',
    'POS_Point' => 'نقطة البيع',
    'All_POS' => 'جميع نقاط البيع',
    'Print' => 'طباعة',
    'Export_Excel' => 'تصدير Excel',
    'Export_PDF' => 'تصدير PDF',
    'No_Data_Available' => 'لا توجد بيانات متاحة للفترة المحددة',
    'Select_Date_Range_Generate_Report' => 'اختر النطاق الزمني لإنشاء التقرير',
    'Choose_dates_above_view_financial_report' => 'اختر التواريخ أعلاه لعرض التقرير المالي',
    'Choose_dates_above_view_pos_report' => 'اختر التواريخ أعلاه لعرض تقرير نقاط البيع',
    ...
    // بطاقات الملخص
    'Total_Revenue' => 'إجمالي الإيرادات',
    'Your_Total_Income' => 'إجمالي دخلك من السائقين',
    'Registration_Revenue' => 'إيرادات التسجيل',
    'From_Driver_Registration' => 'من رسوم تسجيل السائقين',
    'Cards_Revenue' => 'إيرادات البطاقات',
    'From_Recharge_Cards' => 'من بطاقات الشحن',
    'Total_Withdrawals' => 'إجمالي السحوبات',
    'Drivers_Withdrawals' => 'سحوبات السائقين',
    'Total_Drivers' => 'إجمالي السائقين',
    'POS_Commission' => 'عمولة نقاط البيع',
    'Paid_To_POS' => 'المدفوع لنقاط البيع',
    'Added_To_Wallets' => 'المضاف للمحافظ',
    'Total_Recharged' => 'إجمالي المبلغ المشحون',
    'JD' => 'دينار',
    ...
    'Phone' => 'الهاتف',
    'Current_Balance' => 'الرصيد الحالي',
    'Registration_Paid' => 'المبلغ المدفوع للتسجيل',
    'Registration_Kept' => 'المبلغ المحفوظ',
    'Cards_Count' => 'عدد البطاقات المستخدمة',
    'Cards_Net' => 'صافي إيرادات البطاقات',
    'Withdrawals' => 'السحوبات',
    'Actions' => 'الإجراءات',
    'View_Details' => 'عرض التفاصيل',
    'Total' => 'الإجمالي',
    ...
    // صفحة تفاصيل السائق
    'Driver_Financial_Details' => 'التفاصيل المالية للسائق',
    'Back_to_Report' => 'العودة للتقرير',
    'Driver_Information' => 'معلومات السائق',
    'Name' => 'الاسم',
    'Email' => 'البريد الإلكتروني',
    'Status' => 'الحالة',
    ...
    'From' => 'من',
    'paid' => 'مدفوع',
    'cards_used' => 'بطاقة مستخدمة',
    'From_wallet' => 'من المحفظة',
    'Your_profit_from_driver' => 'ربحك من هذا السائق',

    // دفعات التسجيل
    'Registration_Payments' => 'دفعات التسجيل',
    'Date' => 'التاريخ',
    'Total_Paid' => 'إجمالي المدفوع',
    'Amount_Kept' => 'المبلغ المحفوظ',
    'Added_To_Wallet' => 'المضاف للمحفظة',
    'Note' => 'ملاحظة',
    'Admin' => 'المدير',

    // استخدامات البطاقات
    'Recharge_Cards_History' => 'سجل بطاقات الشحن',
    'Card_Number' => 'رقم البطاقة',
    'Card_Price' => 'سعر البطاقة',
    'Recharged_Amount' => 'المبلغ المشحون',
    'POS' => 'نقطة البيع',
    ...
    'Back_to_Drivers_Report' => 'العودة لتقرير السائقين',
    'Total_POS_Points' => 'إجمالي نقاط البيع',
    'Total_Cards_Sold' => 'إجمالي البطاقات المباعة',
    'Total_Sales_Value' => 'إجمالي قيمة المبيعات',
    'Net_Revenue_To_Admin' => 'صافي الإيراد للإدارة',
    'After_POS_Commission' => 'بعد خصم عمولة نقاط البيع',
    'Detailed_POS_Report' => 'التقرير التفصيلي لنقاط البيع',
    'POS_Name' => 'اسم نقطة البيع',
    'Cards_Sold' => 'البطاقات المباعة',
    'Total_Sales' => 'إجمالي المبيعات',
    'Commission' => 'العمولة',
    'Net_To_Admin' => 'الصافي للإدارة',

    // حقول دفعة التسجيل
    'Registration_Payment_Details' => 'تفاصيل دفعة التسجيل',
    'Total_Amount_Paid' => 'المبلغ الإجمالي المدفوع',
    'Total_amount_driver_paid_you' => 'المبلغ الكلي الذي دفعه السائق لك',
    'Amount_Kept_By_Admin' => 'المبلغ المحفوظ (عمولتك)',
    'Amount_you_keep_as_commission' => 'المبلغ الذي تحتفظ به كعمولة',
    'Amount_Added_To_Wallet' => 'المبلغ المضاف للمحفظة',
    'Amount_added_to_driver_wallet' => 'المبلغ المضاف لمحفظة السائق',
    'Payment_Note' => 'ملاحظة الدفعة',
    'Payment_calculation_info' => 'المبلغ الإجمالي = المبلغ المحفوظ + المبلغ المضاف للمحفظة',
    'Registration_Payment_History' => 'سجل دفعات التسجيل',
    'No_payment_history' => 'لا يوجد سجل دفعات',
    'Add_New_Payment' => 'إضافة دفعة جديدة',

    // الملخص الإجمالي
    'Overall_Financial_Summary' => 'الملخص المالي الإجمالي',
    'Drivers_Summary' => 'ملخص السائقين',
    'POS_Summary' => 'ملخص نقاط البيع',
    'Grand_Total_Revenue' => 'إجمالي الإيرادات الكلي',
    'Total_From_Drivers' => 'الإجمالي من السائقين',
    'Total_From_POS' => 'الإجمالي من نقاط البيع',
    'Total_POS_Commission_Paid' => 'إجمالي عمولات نقاط البيع المدفوعة',
    'Total_Drivers_Count' => 'إجمالي عدد السائقين',
    'Total_POS_Count' => 'إجمالي عدد نقاط البيع',
    'Total_Cards_Sold_Count' => 'إجمالي البطاقات المباعة',
    'Combined_Financial_Overview' => 'نظرة عامة مالية مجمعة',
    ...
    'drivers_report' => 'التقرير المالي للسائقين',
    'pos_report' => 'التقرير المالي لنقاط البيع',
    'overall_summary' => 'الملخص المالي الإجمالي',

    // قسم التصفية
    'filter_title' => 'فلاتر التقرير',
    'select_period' => 'اختر فترة التقرير',
    'quick_filters' => 'فلاتر التاريخ السريعة',

    // الإحصائيات
    'statistics' => 'الإحصائيات المالية',
    ...
    'reports' => 'التقارير',
    'Order_Status_History' => 'سجل حالة الطلبات',
    'Financial_Reports' => 'التقارير المالية',
    'Drivers_Financial_Reports' => 'تقارير السائقين',
    'POS_Financial_Report' => 'تقارير نقاط البيع',
    'Overall_Summary' => 'الملخص الإجمالي',
    // صفحة الملخص الإجمالي
    'Overall_Financial_Summary' => 'الملخص المالي الإجمالي',
    'Combined_Financial_Overview' => 'نظرة مالية شاملة من جميع المصادر',
    'Revenue_Breakdown' => 'تفصيل الإيرادات',
    'Revenue_Distribution' => 'توزيع الإيرادات',
    'Detailed_Breakdown' => 'التفصيل التفصيلي',
    'Category' => 'الفئة',
    'Description' => 'الوصف',
    'Percentage' => 'النسبة المئوية',
    'Drivers_Revenue' => 'إيرادات السائقين',
    'POS_Revenue' => 'إيرادات نقاط البيع',
    'Revenue' => 'الإيرادات',
    'pos_commission_percentage' => 'نسبة عمولة نقطة البيع',
    'enter_pos_commission_percentage' => 'أدخل نسبة عمولة نقطة البيع',

    'driver_recharge_amount' => 'مبلغ شحن السائق',
    'enter_driver_recharge_amount' => 'أدخل مبلغ شحن السائق',

    // User Ban Translations
    'Ban_User' => 'حظر المستخدم',
    'Back_To_Users' => 'العودة إلى المستخدمين',
    'User_Information' => 'معلومات المستخدم',
    'Ban_This_User' => 'حظر هذا المستخدم',
    'User_Already_Banned_Message' => 'هذا المستخدم محظور بالفعل. إرسال هذا النموذج سيستبدل الحظر الحالي.',
    'Unban_User' => 'إلغاء حظر المستخدم',
    'User_Never_Banned' => 'لم يتم حظر هذا المستخدم من قبل.',

    // Ban Reasons for Users
    'ban_reason_violation_terms' => 'انتهاك الشروط والأحكام',
    'ban_reason_poor_behavior' => 'سلوك سيء',
    'ban_reason_fraud' => 'نشاط احتيالي',
    'ban_reason_multiple_complaints' => 'شكاوى متعددة',
    'ban_reason_payment_issues' => 'مشاكل الدفع',
    'ban_reason_spam' => 'إساءة استخدام',
    'ban_reason_unprofessional_conduct' => 'سلوك غير مهني',
    'ban_reason_other' => 'أخرى',

    // Existing translations that might be missing
    'Ban_Type' => 'نوع الحظر',
    'Select_Ban_Type' => 'اختر نوع الحظر',
    'Temporary_Ban' => 'حظر مؤقت',
    'Permanent_Ban' => 'حظر دائم',
    ...
    'Additional_Details' => 'تفاصيل إضافية',
    'Provide_Additional_Details' => 'قدم تفاصيل إضافية حول الحظر',
    'Ban_Description_Help' => 'سيتم حفظ هذه المعلومات في النظام للرجوع إليها.',
    'Ban_Warning_Message' => 'حظر هذا المستخدم سيقيد وصوله إلى النظام فوراً. سيتم تسجيل هذا الإجراء.',
    'Ban_History' => 'سجل الحظر',
    'Current_Status' => 'الحالة الحالية',
    'Total_Bans' => 'إجمالي الحظر',
    'Complete_Ban_History' => 'سجل الحظر الكامل',
    ...
    'Unban_Information' => 'معلومات إلغاء الحظر',
    'Unbanned_At' => 'تاريخ إلغاء الحظر',
    'Unbanned_By' => 'تم إلغاء الحظر بواسطة',
    'System_Auto' => 'النظام (تلقائي)',
    'Unban_Reason' => 'سبب إلغاء الحظر',
    'Close' => 'إغلاق',
    'Current_Ban_Info' => 'معلومات الحظر الحالي',
    'Until' => 'حتى',
    'Remaining' => 'المتبقي',
    'Unban_Confirmation_Message' => 'هل أنت متأكد من إلغاء حظر هذا المستخدم؟ سيستعيد الوصول الكامل إلى النظام.',
    'Cancel' => 'إلغاء',
    'Optional' => 'اختياري',
    'Warning' => 'تحذير',
    'Banned_Permanently' => 'محظور بشكل دائم',
...
'Enter_Reason_For_Deletion'   => 'أدخل سبب الحذف...',
    ...
    // ===== مفاتيح جديدة 2026-03-27 =====
    'View_On_Map'                => 'عرض على الخريطة',
    'View_Notified_Drivers'      => 'عرض السائقين الذين أُشعروا',
    'Notified_At'                => 'وقت الإشعار',
    'Search_Radius'              => 'نطاق البحث',
    'No_Drivers_Notified'        => 'لم يتم إشعار أي سائق لهذا الطلب.',
    'Close'                      => 'إغلاق',

    'Specific_User'              => 'مستخدم محدد',
    'Specific_Driver'            => 'سائق محدد',
    'All_Users_And_Drivers'      => 'جميع المستخدمين والسائقين',
    'Only_Users'                 => 'المستخدمون فقط',
    'Only_Drivers'               => 'السائقون فقط',
    'Send_Notification'          => 'إرسال إشعار',
    'Notification_Type'          => 'نوع الإشعار',
    'Body'                       => 'نص الرسالة',
    'Notification_Sent_Successfully' => 'تم إرسال الإشعار بنجاح.',
    'Notification_Queued'        => 'تم إضافة الإشعار للقائمة وسيُرسل قريباً.',

    'Driver_Acceptance_Report'   => 'تقرير قبول السائقين',
    'Total_Active_Drivers'       => 'السائقون النشطون',
    'Total_Accepted_Orders'      => 'إجمالي الطلبات المقبولة',
    'Drivers_Who_Accepted_Orders'=> 'السائقون الذين قبلوا طلبات',
    'Accepted_Orders'            => 'الطلبات المقبولة',
    'First_Acceptance'           => 'أول قبول',
    'Last_Acceptance'            => 'آخر قبول',
    'No_Data_For_This_Date'      => 'لا توجد بيانات لهذا التاريخ.',
    'View_Orders'                => 'عرض الطلبات',

    'expires_days'               => 'مدة الصلاحية (أيام)',
    'expires_days_placeholder'   => 'مثال: 30',
    'expires_days_help'          => 'عدد الأيام قبل انتهاء صلاحية رصيد التطبيق. اتركه فارغاً لعدم وجود صلاحية.',
    'days'                       => 'أيام',
];
