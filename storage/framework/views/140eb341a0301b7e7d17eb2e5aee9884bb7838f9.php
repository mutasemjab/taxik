...
<div class="dashboard-container">
    ...
    <div class="main-content">
        <div class="time-filters">
            <button class="time-filter active" data-period="today"><?php echo e(__('dashboard.today')); ?></button>
            <button class="time-filter" data-period="week"><?php echo e(__('dashboard.this_week')); ?></button>
            <button class="time-filter" data-period="month"><?php echo e(__('dashboard.this_month')); ?></button>
            <button class="time-filter" data-period="year"><?php echo e(__('dashboard.this_year')); ?></button>
        </div>
        ...
        <div class="stats-overview">
            <div class="stat-card earnings">
                <div class="stat-header">
                    ...
                    <div class="stat-trend positive">
                        <span>↗</span> +<?php echo e($earningsGrowth); ?>%
                    </div>
                </div>
                <div class="stat-title"><?php echo e(__('dashboard.total_earnings_today')); ?></div>
                <div class="stat-number">$<?php echo e(number_format($todayEarnings, 2)); ?></div>
            ...
            <div class="stat-card users">
                <div class="stat-header">
                    <div class="stat-icon">👥</div>
                    <div class="stat-trend positive">
                        <span>↗</span> +<?php echo e($usersGrowth); ?>%
                    </div>
                </div>
            ...
            <div class="stat-card drivers">
                <div class="stat-header">
                    <div class="stat-icon">🚗</div>
                    <div class="stat-trend positive">
                        <span>↗</span> +<?php echo e($driversGrowth); ?>%
                    </div>
                </div>
            ...
            <div class="stat-card orders">
                <div class="stat-header">
                    <div class="stat-icon">📦</div>
                    <div class="stat-trend positive">
                        <span>↗</span> +<?php echo e($ordersGrowth); ?>%
                    </div>
                </div>
                ...
                <div class="stat-subtitle"><?php echo e(__('dashboard.completed')); ?>: <?php echo e($completedOrdersToday); ?> | <?php echo e(__('dashboard.pending')); ?>: <?php echo e($pendingOrdersToday); ?></div>
            </div>
        </div>
        ...
        <div class="dashboard-grid">
            <div class="dashboard-card">
                <div class="card-title">
                    <span>📊</span> <?php echo e(__('dashboard.monthly_statistics')); ?>

                </div>
                <div class="monthly-stats">
                    <div class="mini-stat">
                        <div class="mini-stat-icon">💵</div>
                        <div class="mini-stat-number">$<?php echo e(number_format($monthlyEarnings, 2)); ?></div>
            ...
            <div class="dashboard-card">
                <div class="card-title">
                    <span>⚡</span> <?php echo e(__('dashboard.quick_statistics')); ?>
        ...
        <div class="dashboard-card earnings-breakdown">
            <div class="card-title">
                <span>💎</span> <?php echo e(__('dashboard.earnings_details')); ?>
            ...
            <div class="earnings-grid">
                <div class="earnings-card">
                    ...
                    <div class="earnings-amount">$<?php echo e(number_format($totalEarnings, 2)); ?></div>
                ...
                <div class="earnings-card">
                    ...
                    <div class="earnings-amount">$<?php echo e(number_format($adminCommissionToday, 2)); ?></div>
                ...
                <div class="earnings-card">
                    ...
                    <div class="earnings-amount">$<?php echo e(number_format($driversEarningsToday, 2)); ?></div>
                ...
                <div class="earnings-card">
                    ...
                    <div class="earnings-amount">$<?php echo e(number_format($averageOrderValue, 2)); ?></div>
