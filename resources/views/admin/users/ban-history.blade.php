...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-history"></i> {{ __('messages.Ban_History') }} - {{ $user->name }}
        </h1>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-md-2 text-center">
                            @if($user->photo)
                            <img src="{{ asset('assets/admin/uploads/' . $user->photo) }}" alt="{{ $user->name }}" class="img-fluid rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                            @else
                        ...
                        <div class="col-md-10">
                            ...
                            <p class="mb-0">
                                ...
                                <strong class="ml-3">{{ __('messages.Total_Bans') }}:</strong> <span class="badge badge-info">{{ $user->bans->count() }}</span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="banHistoryTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        @foreach($user->bans()->latest()->get() as $ban)
            ...
            <div class="alert alert-info text-center">
                <i class="fas fa-info-circle"></i> {{ __('messages.User_Never_Banned') }}
            </div>
            @endif
        </div>
    </div>
