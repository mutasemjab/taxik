        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.time-filter').forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    document.querySelectorAll('.time-filter').forEach(btn => btn.classList.remove(
                        'active'));
            ...
            document.querySelectorAll('.stat-card, .dashboard-card, .earnings-card, .metric-item, .mini-stat')
                .forEach(element => {
