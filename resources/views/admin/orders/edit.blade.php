                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        <option value="pending" {{ old('status', $order->status) == 'pending' ? 'selected' : '' }}>{{ __('messages.Pending') }}</option>
                                        <option value="accepted" {{ old('status', $order->status) == 'accepted' ? 'selected' : '' }}>{{ __('messages.Accepted') }}</option>
                                        <option value="on_the_way" {{ old('status', $order->status) == 'on_the_way' ? 'selected' : '' }}>{{ __('messages.On_The_Way') }}</option>
                                        <option value="arrived" {{ old('status', $order->status) == 'arrived' ? 'selected' : '' }}>{{ __('messages.Arrived') }}</option>
                                        <option value="started" {{ old('status', $order->status) == 'started' ? 'selected' : '' }}>{{ __('messages.Started') }}</option>
                                        <option value="waiting_payment" {{ old('status', $order->status) == 'waiting_payment' ? 'selected' : '' }}>{{ __('messages.Waiting_Payment') }}</option>
                                        <option value="completed" {{ old('status', $order->status) == 'completed' ? 'selected' : '' }}>{{ __('messages.Completed') }}</option>
                                        <option value="user_cancel_order" {{ old('status', $order->status) == 'user_cancel_order' ? 'selected' : '' }}>{{ __('messages.User_Cancelled') }}</option>
                                        <option value="driver_cancel_order" {{ old('status', $order->status) == 'driver_cancel_order' ? 'selected' : '' }}>{{ __('messages.Driver_Cancelled') }}</option>
                                        <option value="cancel_cron_job" {{ old('status', $order->status) == 'cancel_cron_job' ? 'selected' : '' }}>{{ __('messages.Cancelled_Auto') }}</option>
                                    </select>
                                </div>
                                
                                <div class="form-group cancel-reason-container" 
                                     style="display: {{ in_array(old('status', $order->status), ['user_cancel_order', 'driver_cancel_order', 'cancel_cron_job']) ? 'block' : 'none' }};">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="payment_method" name="payment_method" required>
                                        <option value="cash" {{ old('payment_method', $order->payment_method) == 'cash' ? 'selected' : '' }}>{{ __('messages.Cash') }}</option>
                                        <option value="visa" {{ old('payment_method', $order->payment_method) == 'visa' ? 'selected' : '' }}>{{ __('messages.Visa') }}</option>
                                        <option value="wallet" {{ old('payment_method', $order->payment_method) == 'wallet' ? 'selected' : '' }}>{{ __('messages.Wallet') }}</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status_payment" name="status_payment" required>
                                        <option value="pending" {{ old('status_payment', $order->status_payment) == 'pending' ? 'selected' : '' }}>{{ __('messages.Pending') }}</option>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="trip_started_at" name="trip_started_at" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="trip_completed_at" name="trip_completed_at" 
                                           value="{{ old('trip_completed_at', $order->trip_completed_at ? $order->trip_completed_at->format('Y-m-d\TH:i') : '') }}">
                                </div>

                                <div class="form-group">
                                    <label for="actual_trip_duration_minutes">{{ __('messages.Actual_Duration_Minutes') }}</label>
                                    <input type="number" step="0.01" class="form-control" id="actual_trip_duration_minutes" 
                                           name="actual_trip_duration_minutes" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="live_distance" 
                                           name="live_distance" 
                                           value="{{ old('live_distance', $order->live_distance) }}" 
                                           min="0">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="returned_amount" 
                                           ...
                                           min="0">
                                    <small class="form-text text-muted">{{ __('messages.Returned_Amount_Info') }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control" id="pick_lat" name="pick_lat" 
                                                   value="{{ old('pick_lat', $order->pick_lat) }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pick_lng">{{ __('messages.Longitude') }} <span class="text-danger">*</span></label>
                                            <input type="number" step="any" class="form-control" id="pick_lng" name="pick_lng" 
                                                   value="{{ old('pick_lng', $order->pick_lng) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control" id="drop_lat" name="drop_lat" 
                                                   value="{{ old('drop_lat', $order->drop_lat) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="drop_lng">{{ __('messages.Longitude') }}</label>
                                            <input type="number" step="any" class="form-control" id="drop_lng" name="drop_lng" 
                                                   value="{{ old('drop_lng', $order->drop_lng) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="total_price_before_discount" 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="total_price_after_discount" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="commision_of_admin" 
                                                   name="commision_of_admin" 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="net_price_for_driver" 
                                           name="net_price_for_driver" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="waiting_charges" 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="in_trip_waiting_charges" 
                                                   name="in_trip_waiting_charges" 
